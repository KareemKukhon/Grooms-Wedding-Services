...
class _ProviderPageState extends State<ProviderPage> {
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  image: DecorationImage(
                      image: NetworkImage(
                          server + '/' + widget.providerModel.logo.toString()),
                      fit: BoxFit.cover)),
              child: Container(
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                widget.providerModel!.field ?? "",
                                textAlign: TextAlign.right,
                                style: TextStyle(
                                  color: Color.fromARGB(106, 43, 47, 78),
                                  fontSize: 16.sp,
                                  fontFamily: 'Portada ARA',
                ...
                Row(
                  ...
                  children: [
                    Row(
                      children: [
                        Text(
                          '(${getTotalRatingCount(widget.providerModel).toString()} المراجعات) ',
                        ...
                        Text(
                          calculateAverageRating(widget.providerModel)
                              .toString(),
                          style: TextStyle(
  ...
  int getTotalRatingCount(ProviderModel provider) {
    int totalCount = 0;

    if (provider.services != null) {
      for (ServiceModel service in provider.services!) {
        if (service.ratings != null) {
          totalCount += service.ratings!.length;
        }
      }
    }
